...
<button type="button" class="btn btn-primary" onclick="rescindir(${tr.id});">
...
<input type="checkbox" class="btn-check" autocomplete="off" id="multi${tr.id}" name="jugadoresid" value="${tr.id}"/>
